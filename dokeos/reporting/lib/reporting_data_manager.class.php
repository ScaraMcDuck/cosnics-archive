...
abstract class ReportingDataManager {
	 ...
	 * @param Event $event
	 */
	abstract function create_block(&$reporting_block);
	/**
	 * Updates a reporting block (needed for change of activity)
	 * @param Event $event
	 */
	abstract function update_block(&$reporting_block);
	/**
	 * Retrieves the reporting block with the given name
	 * @param String $name
	 */
	abstract function retrieve_block_by_name($blockname);
	/**
	 * Retrieves all reporting blocks
	 */
	abstract function retrieve_reportingblocks($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
	/**
	 * Counts the reporting blocks for a given condition
	 * @param Condition $condition
	 */
	abstract function count_reportingblocks($condition = null);
	/**
	 * Retrieves a reporting block by given id
	 * @param int $event_id
	 * @return Event $event
	 */
	abstract function retrieve_reportingblock($block_id);
