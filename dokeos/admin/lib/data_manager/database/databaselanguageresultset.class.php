 ...
 */
class DatabaseLanguageResultSet extends ResultSet {
	/**
	 ...
	 */
    function DatabaseLanguageResultSet($data_manager, $handle, $single_type)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_language($record);
		}
    	return null;
    }
	/*
