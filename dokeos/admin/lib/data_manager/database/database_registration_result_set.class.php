 ...
 */
class DatabaseRegistrationResultSet extends ResultSet
{
    /**
     ...
     * resultset
     */
    function DatabaseRegistrationResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
        ...
        {
            return $this->data_manager->record_to_registration($record);
        }
        return null;
    }
