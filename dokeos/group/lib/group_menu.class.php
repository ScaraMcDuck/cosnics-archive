...
class GroupMenu extends HTML_Menu
{
	 ...
	 *                           root.
	 */
	function GroupMenu($current_category, $url_format = '?application=group&go=browse&group_id=%s', $include_root = true, $show_complete_tree = false, $hide_current_category = false)
	{
