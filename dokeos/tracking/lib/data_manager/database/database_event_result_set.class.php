 ...
 */
class DatabaseEventResultSet extends ResultSet
{
    /**
     ...
     * resultset
     */
    function DatabaseEventResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
        ...
        {
            return $this->data_manager->record_to_classobject($record, 'Event');
        }
        return null;
    }
