<?php
/**
 * $Id: quota_viewer.class.php 20956 2009-05-24 17:14:10Z Scara84 $
...
class UserManagerQuotaViewerComponent extends UserManagerComponent
{
	...
	function run()
	{
		...
		$trail->add(new Breadcrumb($this->get_url(), Translation :: get('QuotaOf') . ' ' . $this->selected_user->get_fullname()));
	...
	{
		return RepositoryDataManager :: get_instance()->get_registered_types();
	}
