...
class InstallGenerator
{
    ...
    function generate_install_files($location, $application_name, $author)
    {
        ...
        if ($file)
        {
            ...
            $this->template->assign_vars(array('APPLICATION_NAME' => DokeosUtilities :: camelcase_to_underscores($application_name), 'C_APPLICATION_NAME' => DokeosUtilities :: underscores_to_camelcase($application_name), 'AUTHOR' => $author));
