...
class DataManagerGenerator
{
    ...
    function generate_data_managers($data_manager_location, $database_location, $application_name, $classes, $author)
    {
        ...
        if ($dm_file && $database_file)
        {
            ...
            $this->template->assign_vars(array('APPLICATION_NAME' => DokeosUtilities :: underscores_to_camelcase($application_name), 'L_APPLICATION_NAME' => DokeosUtilities :: camelcase_to_underscores($application_name), 'AUTHOR' => $author));
