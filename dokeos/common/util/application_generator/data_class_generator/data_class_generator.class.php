...
class DataClassGenerator
{
    ...
    function generate_data_class($location, $classname, $properties, $package, $description, $author, $application_name)
    {
        ...
        if ($file)
        {
            ...
            $this->template->assign_vars(array('PACKAGE' => $package, 'DESCRIPTION' => $description, 'AUTHOR' => $author, 'OBJECT_CLASS' => $classname, 'L_OBJECT_CLASS' => DokeosUtilities :: camelcase_to_underscores($classname), 'APPLICATION_NAME' => DokeosUtilities :: underscores_to_camelcase($application_name)));
