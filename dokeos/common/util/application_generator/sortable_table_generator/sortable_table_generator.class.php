...
class SortableTableGenerator
{
    ...
    function generate_tables($default_location, $location, $application_name, $properties, $class, $author)
    {
        ...
        if ($boolean)
        {
            ...
            $this->template->assign_vars(array('APPLICATION_NAME' => DokeosUtilities :: underscores_to_camelcase($application_name), 'L_APPLICATION_NAME' => DokeosUtilities :: camelcase_to_underscores($application_name), 'L_OBJECT_CLASS' => $class_lower, 'OBJECT_CLASS' => $class, 'L_OBJECT_CLASSES' => $class2_lower, 'U_OBJECT_CLASSES' => $class2_upper, 'AUTHOR' => $author));
