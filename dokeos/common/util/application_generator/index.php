...
foreach($files as $file)
{
	...
	$generator = new DataClassGenerator($location, $classname , $properties, $name, $description, $application['author']);
}
...
{
	$new_file = dirname($file) . '/install/' . basename($file);
