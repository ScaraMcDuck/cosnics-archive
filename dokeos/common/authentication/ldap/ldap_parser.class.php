...
/**
 * This class is used to parse the information from the ldap to a user. This class is an example used at
 * hogent and must be adapted for your company to work. Connection information can be added in the 
 * administrator settings of dokeos
 */
class LdapParser
{
