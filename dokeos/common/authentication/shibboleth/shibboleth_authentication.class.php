...
/**
 * This class allow to login into Dokeos by using the Shibboleth authentication system.
 * 
 ...
 *
 * Shibboleth attributes can be mapped to Dokeos user atributes by setting the correct mappings
 ...
 * 
 * 		- the mapping between Shibboleth attributes and Dokeos user attributes
 * 		- the mapping between the 'affiliation' attribute and Dokeos user roles / groups
 * 		- default values for Dokeos user attributes
 * 		- what Dokeos user attributes must be updated when a user logs in again
 * 
