...
abstract class ExternalAuthentication extends Authentication
{
     ...
     * 
     * Note that any modification made in Dokeos are reset for the given
     ...
     * 
     * @param array $role_mapping An array of [user's attribute] <--> [Dokeos group / role ] pairs 
     */
     ...
     * 
     * TODO: move the method in common Dokeos code
    ...
    protected function get_language_code($lang)
    {
        ...
        else if(substr($lang, 0, 3) == 'en-')
        {
            $lang = 'en';
        }
        else if(substr($lang, 0, 3) == 'nl-')
        {
            $lang = 'nl';
        }
        else if(substr($lang, 0, 3) == 'es-')
        {
            $lang = 'es';
        }
     ...
     * is not stored in the Dokeos datasource 
     * 
     * @return bool false
     */
