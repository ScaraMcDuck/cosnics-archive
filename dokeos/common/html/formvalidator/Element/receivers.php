...
class HTML_QuickForm_receivers extends HTML_QuickForm_group
{
	...
	{
		$this->_elements[] = new HTML_QuickForm_Radio('receivers', '', Translation :: get_lang('Everybody'), '0', array ('onclick' => 'javascript:receivers_hide(\'receivers_to\')'));
		$this->_elements[0]->setChecked(true);
		$this->_elements[] = new HTML_QuickForm_Radio('receivers', '', Translation :: get_lang('SelectGroupsUsers'), '1', array ('onclick' => 'javascript:receivers_show(\'receivers_to\')'));
