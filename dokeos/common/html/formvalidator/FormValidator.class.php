...
EOT;
	...
	{
		$group[] = $this->createElement('static','add_resource_img',null,'<img src="'. Theme :: get_common_img_path() . 'action-attachment.png" alt="'.Translation :: get('Attachment').'"/>');
	...
	function add_progress_bar($delay = 2)
	{
		...
		$this->updateAttributes("onsubmit=\"myUpload.start('dynamic_div','".Theme :: get_common_img_path()."action-progress-bar.gif','".Translation :: get('PleaseStandBy')."','".$this->getAttribute('id')."')\"");
