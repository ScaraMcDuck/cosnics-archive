...
EOT;
	...
	function add_progress_bar($delay = 2)
	{
		...
		$this->updateAttributes("onsubmit=\"myUpload.start('dynamic_div','".Theme :: get_common_img_path()."progress_bar.gif','".Translation :: get('PleaseStandBy')."','".$this->getAttribute('id')."')\"");
