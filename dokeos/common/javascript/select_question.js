( function($) 
{
	...
	{   
		...
		var new_type = 'radio';
		var new_label = translation('SwitchToMultipleSelect', 'repository');
		
		if(answer_type == 'radio')
		{
			new_type = 'checkbox';
			new_label = translation('SwitchToSingleSelect', 'repository');
		}
	...
	function add_option_clicked(ev, ui)
	{
		...
		var answer_field = '<input type="text" name="option[' + number_of_options + ']" style="width: 300px;" />';
