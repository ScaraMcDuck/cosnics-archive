 ...
 */
class DatabaseWebserviceResultSet extends ResultSet {
	/**
	 ...
	 * resultset
	 */
    function DatabaseWebserviceResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_webservice($record);
		}
    	return null;
    }
	/*
