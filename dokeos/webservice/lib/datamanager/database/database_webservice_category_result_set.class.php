 ...
 */
class DatabaseWebserviceCategoryResultSet extends ResultSet {
	/**
	 ...
	 * resultset
	 */
    function DatabaseWebserviceCategoryResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_webservice_category($record);
		}
    	return null;
    }
	/*
