 ...
 */
class DatabaseHomeRowResultSet extends ResultSet {
	/**
	 ...
	 */
    function DatabaseHomeRowResultSet($data_manager, $handle, $single_type)
    {
    ...
    function next_result()
    {
		...
		{
			$this->current++;
			return $this->data_manager->record_to_home_row($record);
		}
    	return null;
    }
	/*
