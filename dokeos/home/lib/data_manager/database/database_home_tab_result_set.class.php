 ...
 */
class DatabaseHomeTabResultSet extends ResultSet {
	/**
	 ...
	 * resultset
	 */
    function DatabaseHomeTabResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
		...
		{
			$this->current++;
			return $this->data_manager->record_to_home_tab($record);
		}
    	return null;
    }
	/*
