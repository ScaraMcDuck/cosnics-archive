 ...
 */
class DatabaseHomeBlockResultSet extends ResultSet {
	/**
	 ...
	 */
    function DatabaseHomeBlockResultSet($data_manager, $handle, $single_type)
    {
    ...
    function next_result()
    {
		...
		{
			$this->current++;
			return $this->data_manager->record_to_home_block($record);
		}
    	return null;
    }
	/*
