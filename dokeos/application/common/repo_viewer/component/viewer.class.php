...
class RepoViewerViewerComponent extends RepoViewerComponent
{
	...
	function as_html()
	{
		if (Request :: get(RepoViewer :: PARAM_ID))
		{
			...
			$toolbar_data = array();
			$toolbar_data[] = array(
				'href' => $this->get_url(array_merge($this->get_parameters(), array (RepoViewer :: PARAM_ACTION => 'publicationcreator', RepoViewer :: PARAM_ID => $content_object->get_id()))),
				'img' => Theme :: get_common_image_path().'action_publish.png',
				'label' => Translation :: get('Publish'),
				'display' => DokeosUtilities :: TOOLBAR_DISPLAY_ICON_AND_LABEL
			);
			$toolbar_data[] = array(
				'href' => $this->get_url(array_merge($this->get_parameters(), array (RepoViewer :: PARAM_ACTION => 'publicationcreator', RepoViewer :: PARAM_EDIT_ID => $content_object->get_id()))), //, RepoViewer :: PARAM_EDIT => 1))),
