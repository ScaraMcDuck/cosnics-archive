...
class PublisherViewerComponent extends PublisherComponent
{
	...
	function as_html()
	{
		if ($_GET[Publisher :: PARAM_ID])
		{
			...
			$toolbar_data = array();
			$toolbar_data[] = array(
				'href' => $this->get_url(array_merge($this->get_parameters(), array (Publisher :: PARAM_ACTION => 'publicationcreator', Publisher :: PARAM_ID => $learning_object->get_id()))),
				'img' => Theme :: get_common_img_path().'action_publish.png',
				'label' => Translation :: get('Publish'),
				'display' => DokeosUtilities :: TOOLBAR_DISPLAY_ICON_AND_LABEL
			);
			$toolbar_data[] = array(
				'href' => $this->get_url(array_merge($this->get_parameters(), array (Publisher :: PARAM_ACTION => 'publicationcreator', Publisher :: PARAM_ID => $learning_object->get_id(), ObjectPublisher :: PARAM_EDIT => 1))),
