<?php
/**
 * $Id: week_calendar.class.php 15420 2008-05-26 17:34:32Z Scara84 $
 ...
 */
class MiniWeekCalendar extends CalendarTable
{
	/**
	...
	private function build_table()
	{
		...
		for($hour = 0; $hour < 24; $hour += $this->hour_step)
		{
			...
			for($day = 0; $day < 7; $day++)
			{
				...
				if(count($class) > 0)
				{
					$this->updateCellAttributes($day+1,$hour/$this->hour_step+1,'class="'.implode(' ',$class).'"');
				}
			}
		}
