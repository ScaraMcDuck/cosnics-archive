...
class ForumManagerCreatorComponent extends ForumManagerComponent
{
    ...
    function run()
    {
        ...
        $trail->add(new Breadcrumb($this->get_url(array(ForumManager :: PARAM_ACTION => ForumManager :: ACTION_BROWSE_FORUM_PUBLICATIONS)), Translation :: get('BrowseForumPublications')));
