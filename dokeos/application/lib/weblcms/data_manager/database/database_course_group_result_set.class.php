...
/**
 * This class represents a resultset which represents a set of course_groups.
 */
class DatabaseCourseGroupResultSet extends ResultSet {
	/**
	...
	private $handle;
	/**
	 * Create a new resultset for handling a set of course_groups
	 ...
	 * resultset
	 */
    function DatabaseCourseGroupResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_course_group($record);
		}
    	return null;
    }
	/*
