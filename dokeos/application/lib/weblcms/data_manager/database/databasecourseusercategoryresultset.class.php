 ...
 */
class DatabaseCourseUserCategoryResultSet extends ResultSet {
	/**
	 ...
	 */
    function DatabaseCourseUserCategoryResultSet($data_manager, $handle, $single_type)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_course_user_category($record);
		}
    	return null;
    }
	/*
