 ...
 */
class DatabaseCourseUserRelationResultSet extends ResultSet {
	/**
	 ...
	 */
    function DatabaseCourseUserRelationResultSet($data_manager, $handle, $single_type)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_course_user_relation($record);
		}
    	return null;
    }
	/*
