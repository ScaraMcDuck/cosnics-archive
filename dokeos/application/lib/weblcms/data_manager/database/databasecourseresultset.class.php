 ...
 */
class DatabaseCourseResultSet extends ResultSet {
	/**
	 ...
	 */
    function DatabaseCourseResultSet($data_manager, $handle, $single_type)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_course($record);
		}
    	return null;
    }
	/*
