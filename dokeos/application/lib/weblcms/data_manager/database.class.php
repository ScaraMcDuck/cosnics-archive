...
//		 	echo '</pre>';
	...
	function create_learning_object_publication($publication)
	{
		...
		$props[$this->escape_column_name(LearningObjectPublication :: PROPERTY_SHOW_ON_HOMEPAGE)] = $publication->get_show_on_homepage();
