...
class WeblcmsLpiAttemptObjectiveTracker extends MainTracker
{
    ...
    {
    	return array_merge(parent :: get_default_property_names(), array(self :: PROPERTY_LPI_VIEW_ID, self :: PROPERTY_OBJECTIVE_ID,
    	 				   self :: PROPERTY_SCORE_RAW, self :: PROPERTY_SCORE_MAX, self :: PROPERTY_SCORE_MIN, 
    	 				   self :: PROPERTY_STATUS, self :: PROPERTY_DISPLAY_ORDER));
    }
