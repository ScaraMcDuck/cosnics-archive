...
class LearningObjectPublicationCategoryManager
{
	...
	{
		$form = new LearningObjectPublicationCategoryForm('modify_category', 'post', $this->get_url(array(self :: PARAM_ACTION => self :: ACTION_MODIFY)));
		//$form->build_modification_form();
		if ($form->validate())
		{
