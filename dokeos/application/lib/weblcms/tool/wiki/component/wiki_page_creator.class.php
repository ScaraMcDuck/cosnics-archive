...
class WikiToolPageCreatorComponent extends WikiToolComponent
{
	function run()
	{
        ...
        $pub->set_parameter('wiki_id', $_GET['wiki_id']);
        ...
        {   $cloi = new ComplexLearningObjectItem(array(ComplexLearningObjectItem :: PROPERTY_REF => $_GET['object'], ComplexLearningObjectItem ::PROPERTY_PARENT => $pub->get_parameter('wiki_id'), ComplexLearningObjectItem ::PROPERTY_USER_ID => $pub->get_user_id(), ComplexLearningObjectItem ::PROPERTY_DISPLAY_ORDER => '1'));
            $cloi->create();
