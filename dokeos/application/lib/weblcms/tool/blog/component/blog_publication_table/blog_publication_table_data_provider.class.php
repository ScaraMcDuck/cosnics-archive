 ...
 */
class BlogPublicationTableDataProvider extends ObjectTableDataProvider
{
	/**
	 ...
	 */
    function BlogPublicationTableDataProvider($parent, $owner, $types, $query = null)
    {
    	$this->types = $types;
    	$this->owner = $owner;
    	$this->query = $query;
    ...
    function get_publications($from, $count, $column, $direction)
    {
		...
		$tool_condition = new EqualityCondition(LearningObjectPublication :: PROPERTY_TOOL, 'blog');
