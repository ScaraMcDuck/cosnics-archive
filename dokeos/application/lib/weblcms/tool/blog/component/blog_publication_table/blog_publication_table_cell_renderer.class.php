 ...
 */
class BlogPublicationTableCellRenderer extends DefaultLearningObjectTableCellRenderer
{
	 ...
	 */
	function BlogPublicationTableCellRenderer($browser)
	{
	...
	{
		if ($column === BlogPublicationTableColumnModel :: get_action_column())
		{
		...
		if ($property = $column->get_object_property())
		{
			switch ($property)
			{
				case LearningObject :: PROPERTY_TITLE :
					return '<a href="' . $this->browser->get_url(array(Tool :: PARAM_ACTION => BlogTool :: ACTION_VIEW_BLOG, Tool :: PARAM_PUBLICATION_ID => $publication->get_id() )) . '">' . htmlspecialchars($learning_object->get_title()) . '</a>';
			}
		}
	...
	{
		/*$execute = array(
		'href' => $this->browser->get_url(array(Tool :: PARAM_ACTION => BlogTool :: ACTION_TAKE_EXERCISE, Tool :: PARAM_PUBLICATION_ID => $publication->get_id())),
