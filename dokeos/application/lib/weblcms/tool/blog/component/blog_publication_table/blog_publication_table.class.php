 ...
 */
require_once dirname(__FILE__).'/blog_publication_table_data_provider.class.php';
require_once dirname(__FILE__).'/blog_publication_table_column_model.class.php';
require_once dirname(__FILE__).'/blog_publication_table_cell_renderer.class.php';
 ...
 * publication.
 */
class BlogPublicationTable extends ObjectTable
{
	 ...
	 */
	function BlogPublicationTable($parent, $owner, $types, $query)
	{
		$data_provider = new BlogPublicationTableDataProvider($parent, $owner, $types, $query);
		$column_model = new BlogPublicationTableColumnModel();
		$cell_renderer = new BlogPublicationTableCellRenderer($parent);
		parent :: __construct($data_provider, BlogPublicationTable :: DEFAULT_NAME, $column_model, $cell_renderer);
