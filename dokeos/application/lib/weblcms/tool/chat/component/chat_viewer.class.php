...
class ChatToolViewerComponent extends ChatToolComponent
{
	...
	function get_action_bar()
	{
		...
		$action_bar->add_common_action(new ToolbarItem(Translation :: get('Publish'), Theme :: get_common_img_path().'action_publish.png', $this->get_url(array(ChatTool :: PARAM_ACTION => ChatTool :: ACTION_PUBLISH)), ToolbarItem :: DISPLAY_ICON_AND_LABEL));
