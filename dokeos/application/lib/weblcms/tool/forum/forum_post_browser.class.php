...
class ForumPostBrowser extends LearningObjectPublicationBrowser
{
	...
	{		
		...
		{
			$toolbar_data = array ();
			$toolbar_data[] = array ('href' => $this->get_url(array('forum_action'=>'newpost')), 'img' => Theme :: get_common_image_path().'learning_object/forum.png', 'label' => Translation :: get('NewPost'), 'display' => DokeosUtilities :: TOOLBAR_DISPLAY_ICON_AND_LABEL);
