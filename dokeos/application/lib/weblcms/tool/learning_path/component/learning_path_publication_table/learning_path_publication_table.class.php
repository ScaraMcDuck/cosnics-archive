 ...
 */
require_once dirname(__FILE__).'/learning_path_publication_table_data_provider.class.php';
require_once dirname(__FILE__).'/learning_path_publication_table_column_model.class.php';
require_once dirname(__FILE__).'/learning_path_publication_table_cell_renderer.class.php';
