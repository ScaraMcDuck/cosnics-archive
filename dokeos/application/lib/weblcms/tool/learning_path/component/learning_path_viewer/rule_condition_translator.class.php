	...
	function get_status_from_item($object, $tracker_data)
	{
		...
		foreach($pre_condition_rules as $pre_condition_rule)
		{
			...
			foreach($rules as $rule)
			{
				...
				{
					case "satisfied":
						$condition_status = $this->check_for_satisfied($objective_trackers, $tracker_data); break;
					case "attempted":
						$condition_status = $this->check_for_attempted($tracker_data); break;
					case "completed":
						$condition_status = $this->check_for_completed($tracker_data); break;
				}
