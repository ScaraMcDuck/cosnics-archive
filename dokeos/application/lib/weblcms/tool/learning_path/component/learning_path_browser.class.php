...
class LearningPathToolBrowserComponent extends LearningPathToolComponent
{
	...
	function run()
	{
		...
		$publications = WeblcmsDataManager :: get_instance()->retrieve_learning_object_publications($this->get_course_id(), null, null, null, new EqualityCondition('tool','learning_path'),false, null, null, 0, -1, null, new EqualityCondition('type','introduction'));
	...
	function get_toolbar() 
	{
		...
		$action_bar->set_help_action(HelpManager :: get_tool_bar_help_item('learning path tool'));
