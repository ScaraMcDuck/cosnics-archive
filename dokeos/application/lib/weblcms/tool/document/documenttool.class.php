	...
	function run()
	{
		...
		if($this->is_allowed(ADD_RIGHT))
		{
			...
			foreach ($options as $key => $title)
			{
				...
				$html[] = '<img src="'.Theme :: get_common_img_path().'action-'.$key.'.png" alt="'.Translation :: get($title).'" style="vertical-align:middle;"/> ';
			...
			if($_SESSION['documenttoolmode'] == 0)
			{
				...
				$html[] = '<img src="'.Theme :: get_common_img_path().'action-save.png" alt="'.Translation :: get('Download').'" style="vertical-align:middle;"/> ';
