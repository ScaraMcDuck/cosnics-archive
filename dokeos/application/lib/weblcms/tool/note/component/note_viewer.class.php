...
class NoteToolViewerComponent extends NoteToolComponent
{
	...
	function run()
	{
		...
		$publications = WeblcmsDataManager :: get_instance()->retrieve_learning_object_publications($this->get_course_id(), null, null, null, new EqualityCondition('tool','note'),false, null, null, 0, -1, null, new EqualityCondition('type','introduction'));
	...
	function get_action_bar()
	{
		...
		{
			$action_bar->add_common_action(new ToolbarItem(Translation :: get('PublishIntroductionText'), Theme :: get_common_image_path().'action_publish.png', $this->get_url(array(NoteTool :: PARAM_ACTION => Tool :: ACTION_PUBLISH_INTRODUCTION)), ToolbarItem :: DISPLAY_ICON_AND_LABEL));
		}
