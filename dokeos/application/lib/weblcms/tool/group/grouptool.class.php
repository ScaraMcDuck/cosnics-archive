...
class GroupTool extends Tool
{
	...
	function run()
	{
		...
		else
		{
			switch ($_GET[RepositoryTool :: PARAM_ACTION])
			{
				...
				default :
					$toolbar_data[] = array ('href' => $this->get_url($param_add_group), 'label' => Translation :: get('Create'), 'img' => Theme :: get_common_img_path().'group.gif', 'display' => RepositoryUtilities :: TOOLBAR_DISPLAY_ICON_AND_LABEL);
					$this->display_header($trail);
	...
	function get_grouptool_unsubscribe_modification_links()
	{
		...
		$toolbar_data[] = array ('href' => $this->get_parent()->get_url(array (GroupTool :: PARAM_GROUP_ACTION => GroupTool :: ACTION_SUBSCRIBE)), 'label' => Translation :: get('SubscribeUsers'), 'img' => Theme :: get_common_img_path().'user-subscribe.gif', 'display' => RepositoryUtilities :: TOOLBAR_DISPLAY_ICON_AND_LABEL);
	...
	function get_grouptool_subscribe_modification_links()
	{
		...
		$toolbar_data[] = array ('href' => $this->get_parent()->get_url(array (GroupTool :: PARAM_GROUP_ACTION => GroupTool :: ACTION_UNSUBSCRIBE)), 'label' => Translation :: get('UnsubscribeUsers'), 'img' => Theme :: get_common_img_path().'user-unsubscribe.gif', 'display' => RepositoryUtilities :: TOOLBAR_DISPLAY_ICON_AND_LABEL);
