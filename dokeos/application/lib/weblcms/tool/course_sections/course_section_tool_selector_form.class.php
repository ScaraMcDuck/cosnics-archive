...
class CourseSectionToolSelectorForm extends FormValidator 
{
    ...
    { 
		$sel =& $this->addElement('advmultiselect', 'tools', Translation :: get('SelectTools'), 
								  $this->get_tools(), array('style' => 'width:200px;'));
    ...
    function get_tools()
    {
		...
		{
			if($module->section == $admin_section->get_id()) continue;
