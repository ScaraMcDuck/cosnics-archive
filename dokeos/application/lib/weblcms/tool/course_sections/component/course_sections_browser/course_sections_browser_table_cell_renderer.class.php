...
* @param WeblcmsBrowserComponent $browser
	...
	private function get_modification_links($course_section)
	{
		...
		if(!in_array($course_section->get_name(), $array))
		{
			...
			$toolbar_data[] = array(
					'href' => $this->browser->get_url(array(CourseSectionsTool :: PARAM_ACTION => CourseSectionsTool :: ACTION_REMOVE_COURSE_SECTION, 
												   CourseSectionsTool :: PARAM_COURSE_SECTION_ID => $course_section->get_id())),
		...
		{
			$toolbar_data[] = array(
					'href' => $this->browser->get_url(array(CourseSectionsTool :: PARAM_ACTION => CourseSectionsTool :: ACTION_MOVE_COURSE_SECTION, 
												   CourseSectionsTool :: PARAM_COURSE_SECTION_ID => $course_section->get_id(),
