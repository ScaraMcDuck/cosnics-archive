...
class CourseSectionsToolViewerComponent extends CourseSectionsToolComponent
{
	...
	function get_action_bar()
	{
		...
		$action_bar->add_common_action(new ToolbarItem(Translation :: get('Create'), Theme :: get_common_img_path().'action_publish.png', $this->get_url(array(CourseSectionsTool :: PARAM_ACTION => CourseSectionsTool :: ACTION_CREATE_COURSE_SECTION)), ToolbarItem :: DISPLAY_ICON_AND_LABEL));
