 ...
 */
class SearchPortalPublicationChangesTracker extends DefaultTracker
{	
	/**
	 * Constructor sets the default values
	 */
    function SearchPortalPublicationChangesTracker() 
    {
    	parent :: MainTracker('search_portal_publication_changes');
    }
