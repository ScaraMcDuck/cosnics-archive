...
class Item extends DataClass
{
	...
	{
		return parent :: get_default_property_names(array (self :: PROPERTY_CATEGORY, self :: PROPERTY_NAME, 
					  self :: PROPERTY_DESCRIPTION, self :: PROPERTY_RESPONSIBLE, 
					  self :: PROPERTY_CREDITS, self :: PROPERTY_BLACKOUT, self :: PROPERTY_STATUS,
					  self :: PROPERTY_SALTO_ID, self :: PROPERTY_CREATOR));
	}
