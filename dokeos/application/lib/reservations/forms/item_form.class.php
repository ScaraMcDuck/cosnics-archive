...
class ItemForm extends FormValidator {
    ...
    {	
		...
		$this->addElement('html_editor', Item :: PROPERTY_DESCRIPTION, Translation :: get('Description'));
		$this->addRule(Item :: PROPERTY_DESCRIPTION, Translation :: get('ThisFieldIsRequired'), 'required');
	...
	function setDefaults($defaults = array ())
	{
		...
		$defaults[Item :: PROPERTY_RESPONSIBLE] = $item->get_responsible();
		$defaults[Item :: PROPERTY_CREDITS] = $item->get_credits();
