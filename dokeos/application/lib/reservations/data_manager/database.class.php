...
class DatabaseReservationsDataManager extends ReservationsDataManager
{
	...
	function initialize()
	{
		$this->db = new Database(array('category' => 'cat','item' => 'i','quota' => 'q', 'quota_box' => 'qb', 'quota_rel_quota_box' => 'qrqb', 
			'quota_box_rel_category' => 'qbrc', 'quota_box_rel_category_rel_user' => 'qbrcru', 'quota_box_rel_category_rel_group' => 'qbrcrg',
			'reservation' => 'res', 'subscription' => 'sub', 'user_quota' => 'uq', 'subscription_user' => 'sru', 'overview_item' => 'ovi'));
	...
	{
		return $this->db->retrieve_objects('reservation', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		$query = 'UPDATE '.$this->db->escape_table_name('category').' SET '.
				 $this->db->escape_column_name(Category :: PROPERTY_DISPLAY_ORDER).'='.
				 $this->db->escape_column_name(Category :: PROPERTY_DISPLAY_ORDER).'-1 WHERE '.
				 $this->db->escape_column_name(Category :: PROPERTY_DISPLAY_ORDER).'>? AND ' .
	...
	{
		return $this->db->retrieve_objects('category', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->db->retrieve_objects('item', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->db->retrieve_objects('quota', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->db->retrieve_objects('subscription', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->db->retrieve_objects('subscription_user', $condition, $offset, $count, $order_property, $order_direction);
	}
	
	function select_next_display_order($parent_category_id)
	{
		$query = 'SELECT MAX(' . Category :: PROPERTY_DISPLAY_ORDER . ') AS do FROM ' . 
	...
	function retrieve_weight_user_reservations_between($min_start, $max_start, $user_id, $quota_box)
	{
		...
		$query .= 'WHERE ( ( (r.type=\'2\' AND r.start_date >= ? AND r.start_date < ?) ';
		$query .= 'OR (r.type=\'1\' AND s.start_time >= ? AND s.start_time < ?) ';
		$query .= ') AND s.user_id=? AND r.status=\'0\' AND s.status = \'0\' AND s.quota_box = ?)';
	...
	{
		return $this->db->retrieve_objects('quota_box', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	function retrieve_quota_rel_quota_boxes($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null)
	{
		return $this->db->retrieve_objects('quota_rel_quota_box', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->db->retrieve_objects('quota_box_rel_category', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	/*function retrieve_quota_boxes_from_category($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null)
	{
	...
	function retrieve_quota_box_rel_category_rel_users($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null)
	{
		return $this->db->retrieve_objects('quota_box_rel_category_rel_user', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	function retrieve_quota_box_rel_category_rel_groups($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null)
	{
		return $this->db->retrieve_objects('quota_box_rel_category_rel_group', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->db->retrieve_objects('overview_item', $condition, $offset, $count, $order_property, $order_direction);
	}
	...
	function retrieve_quota_box_from_user_for_category($user_id, $category_id)
	{
		$query = 'SELECT quota_box_id FROM reservations_quota_box_rel_category WHERE category_id = ? AND id IN (SELECT quota_box_rel_category_id FROM 
				  reservations_quota_box_rel_category_rel_user WHERE user_id = ?);';
