<?php
/**
 * $Id: personal_calendar_renderer.class.php 14780 2008-04-08 07:45:10Z Scara84 $
...
abstract class ReservationsCalendarRenderer
{
	...
	function ReservationsCalendarRenderer($browser,$display_time)
	{
		...
		$this->legend = array(
			Translation :: get('OpenReservation') => 'lime', 
			Translation :: get('Timepicker') => 'navy',
			Translation :: get('TimepickerToSmall') => 'yellow',
			Translation :: get('Outofperiod') => 'orange',
			Translation :: get('Reserved') => 'red',
			Translation :: get('Blackout') => 'black',
			Translation :: get('Now') => '#FF9999'
		);
	}
	/**
