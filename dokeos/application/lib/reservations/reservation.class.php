...
class Reservation extends DataClass
{
	...
	{
		return parent :: get_default_property_names(array (self :: PROPERTY_ITEM, self :: PROPERTY_TYPE, 
					  self :: PROPERTY_START_DATE, self :: PROPERTY_STOP_DATE, 
					  self :: PROPERTY_START_SUBSCRIPTION, self :: PROPERTY_STOP_SUBSCRIPTION,
					  self :: PROPERTY_MAX_USERS, self :: PROPERTY_NOTES, 
					  self :: PROPERTY_TIMEPICKER_MIN, self :: PROPERTY_TIMEPICKER_MAX,
	...
	function allow_create()
	{
		...
		$stamp_start = DokeosUtilities :: time_from_datepicker($this->get_start_date());
		$stamp_end = DokeosUtilities :: time_from_datepicker($this->get_stop_date());
		...
		{
			$stamp_until = DokeosUtilities :: time_from_datepicker($this->get_stop_subscription());
