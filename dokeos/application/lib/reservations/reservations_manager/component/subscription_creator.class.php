...
class ReservationsManagerSubscriptionCreatorComponent extends ReservationsManagerComponent
{
	/**
	...
	function run()
	{
		...
		$trail->add(new Breadcrumb($this->get_url(array(ReservationsManager :: PARAM_ACTION => ReservationsManager :: ACTION_BROWSE_ITEMS)), Translation :: get('View items')));
		$trail->add(new Breadcrumb($this->get_url(array(ReservationsManager :: PARAM_ACTION => ReservationsManager :: ACTION_BROWSE_RESERVATIONS, ReservationsManager :: PARAM_ITEM_ID => $reservation->get_item())), Translation :: get('View reservations')));
		$trail->add(new Breadcrumb($this->get_url(array(ReservationsManager :: PARAM_RESERVATION_ID => $reservation_id)), Translation :: get('Create subscription')));
	...
	function parse_status($status)
	{
		switch($status)
		{
			case 2: return Translation :: get('UserAllreadySubscribed');
			case 3: return Translation :: get('MaxUsersReached');
			case 4: return Translation :: get('ChosenTimeNotInReservationPeriod');
			case 5: return Translation :: get('TimewindowNotInTimepickerLimits');
			case 6: return Translation :: get('AnotherSubscription');
			case 7: return Translation :: get('OutOfSubscriptionPeriod');
			case 8: return Translation :: get('NotEnoughCredits');
			case 9: return Translation :: get('StartTimeInPast');
		}
	}
}
?>