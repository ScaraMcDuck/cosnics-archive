...
class QuotaBrowserTableDataProvider extends ObjectTableDataProvider
{
   ...
   */
  function QuotaBrowserTableDataProvider($browser, $condition)
  {
   ...
   */
    function get_objects($offset, $count, $order_property = null, $order_direction = null)
    {
		...
		$order_direction = $this->get_order_property($order_direction);
     	...
     	return $this->get_browser()->retrieve_quotas($this->get_condition(), $offset, $count, $order_property, $order_direction);
