...
class ReservationsManager extends WebApplication
{
	...
	{
		return $this->dm->retrieve_items($condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->dm->retrieve_categories($condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->dm->retrieve_reservations($condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->dm->retrieve_quotas($condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->dm->retrieve_quota_boxes($condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->dm->retrieve_quota_box_rel_categories($condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->dm->retrieve_subscriptions($condition, $offset, $count, $order_property, $order_direction);
	}
	
	function retrieve_subscription_users($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null)
	{
		return $this->dm->retrieve_subscription_users($condition, $offset, $count, $order_property, $order_direction);
	}
	...
	{
		return $this->dm->retrieve_overview_items($condition, $offset, $count, $order_property, $order_direction);
	}
