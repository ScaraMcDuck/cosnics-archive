    ...
    function get_condition()
    {
        ...
        if (!empty($user_id) || !empty($groups))
        {
            $access[] = new AndCondition(array(
                                    new EqualityCondition(WebconferenceUser :: PROPERTY_USER, null, $datamanager->get_database()->get_alias(WebconferenceUser :: get_table_name())),
                                    new EqualityCondition(WebconferenceGroup :: PROPERTY_GROUP_ID, null, $datamanager->get_database()->get_alias(WebconferenceGroup :: get_table_name()))
                                               ));
        }
