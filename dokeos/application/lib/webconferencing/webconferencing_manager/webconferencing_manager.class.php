 ...
 */
 class WebconferencingManager extends WebApplication
 {
	...
	{
		return $this->get_url(array(self :: PARAM_ACTION => self :: ACTION_EDIT_WEBCONFERENCE,
								    self :: PARAM_WEBCONFERENCE => $webconference->get_id()));
	}

 	function get_delete_webconference_url($webconference)
	{
		return $this->get_url(array(self :: PARAM_ACTION => self :: ACTION_DELETE_WEBCONFERENCE,
								    self :: PARAM_WEBCONFERENCE => $webconference->get_id()));
	}
