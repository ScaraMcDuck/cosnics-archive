<?php
/**
 * $Id: personalcalendarbrowser.class.php 12549 2007-06-06 10:45:06Z bmol $
...
class CalendarEventBrowser extends CalendarEventPublisherComponent
{
	...
	*/
	public function as_html()
	{
		...
		$publish_url_format = $this->get_url(array (CalendarEventPublisher :: PARAM_ACTION => 'browser','action' => 'publish', 'learning_object_id' => '__ID__'),false);
