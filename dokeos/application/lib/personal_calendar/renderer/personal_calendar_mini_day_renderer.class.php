<?php
/**
 * $Id: personal_calendar_day_renderer.class.php 15496 2008-05-30 08:43:29Z Scara84 $
 * @package application.personal_calendar
 */
require_once (dirname(__FILE__).'/../personal_calendar_renderer.class.php');
require_once (Path :: get_application_library_path().'mini_day_calendar.class.php');
/**
