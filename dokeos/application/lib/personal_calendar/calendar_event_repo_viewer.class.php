...
class CalendarEventRepoViewer extends RepoViewer
{
	function CalendarEventRepoViewer($parent, $types, $mail_option = false)
	{
	...
	function as_html()
	{
		...
		require_once dirname(__FILE__).'/repo_viewer/calendar_event_'.$action.'.class.php';
		$class = 'CalendarEventRepoViewer'.ucfirst($action).'Component';
