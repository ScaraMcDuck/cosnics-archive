...
class PersonalMessengerNew extends PersonalMessengerBlock
{
	...
	function as_html()
	{
		...
		$html[] = '<div class="block" id="b'. $this->get_block_info()->get_id() .'" style="background-image: url('.Theme :: get_common_img_path().'block_'.strtolower(PersonalMessenger :: APPLICATION_NAME).'.png);">';
