...
class PublicationTableColumn
{
	 ...
	 * column.
	 */
	private $personal_message_property;
	/**
	...
	function PublicationTableColumn($property_name_or_column_title, $contains_personal_message_property = false)
	{
		if ($contains_personal_message_property)
		{
			...
			$this->title = get_lang(ucfirst($this->personal_message_property));
			$this->sortable = true;
		}
		else
		{
	 ...
	 *                arbitrary content.
	 */
	function get_personal_message_property()
	{
		return $this->personal_message_property;
	}
	/**
