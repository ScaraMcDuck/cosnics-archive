<?php
/**
 * @package application.lib.profiler.profiler_manager.component.portfolioepublicationbrowser
 */
require_once Path :: get_library_path() . 'html/table/object_table/object_table_data_provider.class.php';
/**
 * Data provider for a portfolio browser table.
 *
...
class PortfolioPublicationBrowserTableDataProvider extends ObjectTableDataProvider
{
   ...
   */
    function get_objects($offset, $count, $order_property = null, $order_direction = null)
    {
      ...
      return $this->get_browser()->retrieve_portfolio_publications($this->get_condition(), $order_property, $order_direction, $offset, $count);
    }
  /**
