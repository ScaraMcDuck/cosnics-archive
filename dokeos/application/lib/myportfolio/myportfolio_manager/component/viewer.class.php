...
{	
	...
	{
		$breadcrumbs = array();
		$breadcrumbs[] = array ('url' => $this->get_url(), 'name' => get_lang('ViewProfile'));
		...
		if ($item)
		{
			...
			$breadcrumbs = array();
			$breadcrumbs[] = array ('url' => $this->get_url(), 'name' => get_lang('ViewPortfolio') . ': ' . $this->publication->get_publication_publisher()->get_username());
...
//			print '<a href="'.$this->get_url(array (MyPortfolio :: PARAM_ACTION => MyPortfolio::ACTION_CREATE, MyPortfolio :: PARAM_ITEM => $item), true).'">'.get_lang("pf_create_child").'</a>';
//			print '<a href="'.$this->get_url(array (MyPortfolio :: PARAM_ACTION => MyPortfolio::ACTION_EDIT, MyPortfolio :: PARAM_ITEM => $item), true).'">'.get_lang("pf_edit_item").'</a>';
//			print '<a href="'.$this->get_url(array (MyPortfolio :: PARAM_ACTION => MyPortfolio::ACTION_DELETE, MyPortfolio :: PARAM_ITEM => $item), true).'">'.get_lang("pf_delete_item").'</a><br /><br />';
		...
		{
			$this->display_error_page(htmlentities(get_lang('NoPortfolioSelected')));
		}
	}
