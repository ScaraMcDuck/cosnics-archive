 ...
 */
class DatabaseRdpublicationResultSet extends ResultSet {
	/**
	 ...
	 * resultset
	 */
    function DatabaseRdpublicationResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_rdpublication($record);
		}
    	return null;
    }
	/*
