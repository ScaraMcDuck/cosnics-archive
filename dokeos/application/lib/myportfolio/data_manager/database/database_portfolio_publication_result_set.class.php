 ...
 */
class DatabasePortfolioPublicationResultSet extends ResultSet {
	/**
	 ...
	 * resultset
	 */
    function DatabasePortfolioPublicationResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_portfolio_publication($record);
		}
    	return null;
    }
	/*
