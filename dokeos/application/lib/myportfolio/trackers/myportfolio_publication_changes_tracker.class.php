 ...
 */
class MyportfolioPublicationChangesTracker extends DefaultTracker
{
	 ...
	 */
    function MyportfolioPublicationChangesTracker()
    {
    	parent :: MainTracker('myportfolio_publication_changes');
    }
