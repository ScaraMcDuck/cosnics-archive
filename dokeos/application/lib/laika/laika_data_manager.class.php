...
abstract class LaikaDataManager
{
	...
	abstract function retrieve_laika_questions($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
	...
	abstract function retrieve_laika_scales($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
	
	abstract function retrieve_laika_result($id);
	
	abstract function retrieve_laika_results($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
	...
	abstract function retrieve_laika_clusters($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
	
	abstract function retrieve_laika_calculated_result($id);
	
	abstract function retrieve_laika_calculated_results($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
	
	abstract function retrieve_laika_attempt($id);
	
	abstract function retrieve_laika_attempts($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
	
	abstract function retrieve_laika_answer($id);
	
	abstract function retrieve_laika_answers($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
	
	abstract function retrieve_percentile_codes($condition = null, $order_direction = SORT_ASC);
	
	abstract function retrieve_statistical_attempts($users = array(), $attempt = SORT_ASC);
	
	abstract function retrieve_laika_users($condition = null, $offset = null, $count = null, $order_property = null, $order_direction = null);
