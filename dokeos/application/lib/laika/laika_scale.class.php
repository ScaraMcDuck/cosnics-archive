...
class LaikaScale
{
	...
	{
		return array (self :: PROPERTY_ID, self :: PROPERTY_CLUSTER_ID, self :: PROPERTY_TITLE, self :: PROPERTY_DESCRIPTION);
	}
	...
	{
		$ldm = LaikaDataManager :: get_instance();
		return $ldm->update_laika_scale($this);
	}
	function delete()
	{
		$ldm = LaikaDataManager :: get_instance();
		return $ldm->delete_laika_scale($this);
	}
	...
	{
		return $this->get_default_property(self :: PROPERTY_CLUSTER_ID);
	}
	
	function set_cluster_id($cluster_id)
	{
		$this->set_default_property(self :: PROPERTY_CLUSTER_ID, $cluster_id);
	}
	...
	{
		return LaikaDataManager :: get_instance()->retrieve_laika_cluster($this->get_cluster_id());
	}
}
?>