...
class LaikaBrowserFilterForm extends FormValidator
{
	...
	function get_filter_conditions()
	{
		...
		if($form_validates)
		{
			...
			$filter_start_date = DokeosUtilities :: time_from_datepicker_without_timepicker($values[self :: USER_FILTER_START_DATE]);
			$filter_end_date = DokeosUtilities :: time_from_datepicker_without_timepicker($values[self :: USER_FILTER_END_DATE]);			
	...
	function get_filter_parameters()
	{
		...
		if($this->validate())
		{
			...
			$parameters = array();
			$parameters[self :: USER_FILTER_START_DATE] = DokeosUtilities :: time_from_datepicker_without_timepicker($values[self :: USER_FILTER_START_DATE]);
			$parameters[self :: USER_FILTER_END_DATE] = DokeosUtilities :: time_from_datepicker_without_timepicker($values[self :: USER_FILTER_END_DATE]);
