...
class QuestionsLaikaWizardPage extends LaikaWizardPage
{
	...
	function buildForm()
	{
		...
		$this->addElement('html', '<div style="padding-bottom: 10px; margin-bottom: 10px; border-bottom: 1px solid #c0c0c0;"><div style="float: left; width: 35%;"></div><div style="float: right; width: 64%;"><div style="float:left; width: 20%; text-align: center;">'. Translation :: get('NotTypical') .'</div><div style="float:left; width: 20%; text-align: center;">'. Translation :: get('NotVeryTypical') .'</div><div style="float:left; width: 20%; text-align: center;">'. Translation :: get('SomewhatTypical') .'</div><div style="float:left; width: 20%; text-align: center;">'. Translation :: get('FairlyTypical') .'</div><div style="float:left; width: 20%; text-align: center;">'. Translation :: get('VeryTypical') .'</div><div class="clear"></div></div><div class="clear"></div></div>');
		...
		while($question = $questions->next_result())
		{
			...
			$renderer->setElementTemplate('<div style="padding-bottom: 10px; margin-bottom: 10px; border-bottom: 1px solid #c0c0c0;"><div style="float: left; width: 35%;">{label}</div><div style="float: right; width: 64%;">{element}<div class="clear"></div></div><div class="clear"></div></div>', 'question[' . $question->get_id() . ']');
