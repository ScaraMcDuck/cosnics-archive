...
class LaikaCalculatedResult
{
	...
	{
		return array (self :: PROPERTY_ID, self :: PROPERTY_ATTEMPT_ID, self :: PROPERTY_SCALE_ID, self :: PROPERTY_RESULT, self :: PROPERTY_PERCENTILE, self :: PROPERTY_PERCENTILE_CODE);
	}
	...
	{
		$ldm = LaikaDataManager :: get_instance();
		return $ldm->update_laika_calculated_result($this);
	}
	function delete()
	{
		$ldm = LaikaDataManager :: get_instance();
		return $ldm->delete_laika_calculated_result($this);
	}
