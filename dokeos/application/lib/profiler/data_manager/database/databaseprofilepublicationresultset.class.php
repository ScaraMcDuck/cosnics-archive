 ...
 */
class DatabaseProfilePublicationResultSet extends ResultSet {
	/**
	 ...
	 */
    function DatabaseProfilePublicationResultSet($data_manager, $handle)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_profile_publication($record);
		}
    	return null;
    }
	/*
