...
class DatabaseProfilerDataManager extends ProfilerDataManager {
	...
	function delete_category($category)
	{
		...
		$query = 'UPDATE '.$this->database->escape_table_name('profiler_category').' SET '.
				 $this->database->escape_column_name(ProfilerCategory :: PROPERTY_DISPLAY_ORDER).'='.
				 $this->database->escape_column_name(ProfilerCategory :: PROPERTY_DISPLAY_ORDER).'-1 WHERE '.
				 $this->database->escape_column_name(ProfilerCategory :: PROPERTY_DISPLAY_ORDER).'>? AND ' .
				 $this->database->escape_column_name(ProfilerCategory :: PROPERTY_PARENT) . '=?';
		$statement = $this->database->get_connection()->prepare($query);
	...
	function select_next_category_display_order($parent_category_id)
	{
		...
		$this->database->escape_table_name('profiler_category');
