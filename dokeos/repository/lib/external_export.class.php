...
//	            }
	...
	{
	    return StringTool :: remove_trailing($string, '/');
	}
	...
	{
	    return StringTool :: ensure_start_with($string, '/');
	}
    ...
    private static function require_once_external_repository_class_file($type)
    {
        if(isset($type) && strlen($type) > 0 && !in_array($type, self :: $already_required_types))
        {
            ...
            $file_name  = DokeosUtilities :: camelcase_to_underscores($class_name) . '.class.php';
