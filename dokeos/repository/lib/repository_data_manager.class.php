...
//		}
	...
	private function load_types()
	{
		...
		$learning_object_types = array('announcement', 'assessment', 'calendar_event', 'introduction', 'description', 'document', 'feedback', 'fill_in_blanks_question', 'forum', 'forum_post', 'forum_topic', 'learning_path', 'learning_path_chapter', 'learning_path_item', 'link', 'matching_question', 'multiple_choice_question', 'open_question', 'personal_message', 'portfolio_item', 'profile', 'rss_feed', 'userinfo_content', 'userinfo_def', 'wiki', 'system_announcement');
