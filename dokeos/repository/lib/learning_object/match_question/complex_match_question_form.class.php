...
require_once dirname(__FILE__) . '/complex_match_question.class.php';
/**
 * This class represents a form to create or update complex assessments
 */
class ComplexMatchQuestionForm extends ComplexLearningObjectItemForm
{
	...
	{
		$elements[] = $this->createElement('text', ComplexMatchQuestion :: PROPERTY_WEIGHT, Translation :: get('Weight'), array("size" => "50"));
		return $elements;
	}
	...
	function get_default_values()
	{
		...
		if (isset ($cloi))
		{
			$defaults[ComplexMatchQuestion :: PROPERTY_WEIGHT] = $cloi->get_weight() ? $cloi->get_weight() : 0;
		}
	...
	{ 
		...
		$cloi->set_weight($values[ComplexMatchQuestion :: PROPERTY_WEIGHT]); 
