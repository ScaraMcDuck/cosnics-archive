...
class CalendarEventDisplay extends LearningObjectDisplay
{
	...
	function get_description()
	{
		...
		$prepend = '<div class="calendar_event_range">'.htmlentities(Translation :: get('From').' '.Text :: format_locale_date($date_format,$object->get_start_date()).' '.Translation :: get('Until').' '.Text :: format_locale_date($date_format,$object->get_end_date())).'</div>';
