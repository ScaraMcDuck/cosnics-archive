...
class ProfileDisplay extends LearningObjectDisplay
{
	...
	function get_full_html()
	{
		...
		if ($object->get_address() != '')
		{
			...
			$html[] = '<div class="title">'. Translation :: get_lang('Address') .'</div>';
		...
		if ($object->get_mail() != '' || $object->get_phone() != '' || $object->get_fax() != '' || $object->get_skype() != '' || $object->get_msn() != '' || $object->get_aim() != '' || $object->get_yim() != '' || $object->get_icq() != '')
		{
			...
			$html[] = '<div class="title">'. Translation :: get_lang('Contact') .'</div>';
			if ($object->get_mail() != '') $html[] = Translation :: get_lang('Mail') . ': <a href="mailto:' . $object->get_mail() . '">' . $object->get_mail() . '</a><br/>';
			if ($object->get_phone() != '') $html[] = Translation :: get_lang('TelShort') . ': ' . $object->get_phone() . '<br/>';
			if ($object->get_fax() != '') $html[] = Translation :: get_lang('FaxShort') . ': ' . $object->get_fax() . '<br/>';
			if ($object->get_skype() != '') $html[] = Translation :: get_lang('Skype') . ': ' . $object->get_skype() . '<br/>';
			if ($object->get_msn() != '') $html[] = Translation :: get_lang('Msn') . ': ' . $object->get_msn() . '<br/>';
			if ($object->get_yim() != '') $html[] = Translation :: get_lang('Yim') . ': ' . $object->get_yim() . '<br/>';
			if ($object->get_aim() != '') $html[] = Translation :: get_lang('Aim') . ': ' . $object->get_aim() . '<br/>';
			if ($object->get_icq() != '') $html[] = Translation :: get_lang('Icq') . ': ' . $object->get_icq() . '<br/>';
			$html[] = '</div>';
		}
		...
		if ($object->get_competences() != '')
		{
			...
			$html[] = '<div class="title">'. Translation :: get_lang('Competences') .'</div>';
		...
		if ($object->get_diplomas() != '')
		{
			...
			$html[] = '<div class="title">'. Translation :: get_lang('Diplomas') .'</div>';
		...
		if ($object->get_teaching() != '')
		{
			...
			$html[] = '<div class="title">'. Translation :: get_lang('Teaching') .'</div>';
		...
		if ($object->get_open() != '')
		{
			...
			$html[] = '<div class="title">'. Translation :: get_lang('Open') .'</div>';
