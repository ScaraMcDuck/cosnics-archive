...
class ComplexAnswerForm extends ComplexLearningObjectItemForm
{
    ...
    protected function build_creation_form()
    {
    	...
    	$this->addElement('text', ComplexAnswer :: PROPERTY_WEIGHT, Translation :: get('Weight'));
    }
    // Inherited
	...
	function setDefaults($defaults = array ())
	{
		...
		if (isset ($cloi))
		{
			$defaults[ComplexAnswer :: PROPERTY_WEIGHT] = $cloi->get_weight();
		}
	...
	{	
		$defaults[ComplexAnswer :: PROPERTY_WEIGHT] = $valuearray[0];
	...
	{ 
		...
		$cloi->set_test($values[ComplexAnswer :: PROPERTY_WEIGHT]); 
