...
class ComplexFillInBlanksQuestionForm extends ComplexLearningObjectItemForm
{
  	protected function build_creation_form()
    {
    	...
    	$this->addElement('text', ComplexFillInBlanksQuestion :: PROPERTY_WEIGHT, Translation :: get('Weight'), array("size" => "50"));
    }
    // Inherited
	...
	function setDefaults($defaults = array ())
	{
		...
		if (isset ($cloi))
		{
			$defaults[ComplexFillInBlanksQuestion :: PROPERTY_WEIGHT] = $cloi->get_weight();
		}
