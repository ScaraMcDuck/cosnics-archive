	...
	private function add_options()
	{
		...
		for($option_number = 0; $option_number <$number_of_options ; $option_number++)
		{
			if(!in_array($option_number,$_SESSION['mc_skip_options']))
			{
				...
				{
					$group[] = $this->createElement('image','remove['.$option_number.']',Theme :: get_common_img_path().'list-remove.png');
				}
		...
		$this->addElement('image','add[]',Theme :: get_common_img_path().'list-add.png');
	}
