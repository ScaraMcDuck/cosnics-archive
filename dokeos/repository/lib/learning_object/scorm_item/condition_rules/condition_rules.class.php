...
class ConditionRules
{
	...
	function add_condition_rule($condition_rule, $type)
	{
		switch($type)
		{
			case 'pre': $this->precondition_rules[] = $condition_rule; break;
			case 'post': $this->postcondition_rules[] = $condition_rule; break;
			case 'exit': $this->exitcondition_rules[] = $condition_rule; break;
			default: $this->precondition_rules[] = $condition_rule; break;
		}
	}
}
?>