 ...
 */
class ComplexMatrixQuestionForm extends ComplexLearningObjectItemForm
{
    ...
    {
        $elements[] = $this->createElement('text', ComplexMatrixQuestion :: PROPERTY_WEIGHT, Translation :: get('Weight'), array("size" => "50"));
        return $elements;
    }
    ...
    function get_default_values()
    {
        ...
        if (isset($cloi))
        {
            $defaults[ComplexMatrixQuestion :: PROPERTY_WEIGHT] = $cloi->get_weight() ? $cloi->get_weight() : 0;
        }
    ...
    function create_complex_learning_object_item()
    {
        ...
        $cloi->set_weight($values[ComplexMatrixQuestion :: PROPERTY_WEIGHT]);
