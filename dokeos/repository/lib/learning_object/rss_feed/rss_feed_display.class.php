...
class RssFeedDisplay extends LearningObjectDisplay
{
	...
	function get_full_html()
	{
		...
		$html[] = '<div class="learning_object" style="background-image: url('.$this->get_path(WEB_IMG_PATH).$object->get_icon_name().($object->is_latest_version() ? '' : '_na').'.png);">';
		...
		{
			$html[] = '<div class="learning_object" style="background-image: url('.$this->get_path(WEB_IMG_PATH).'news_article.png);">';
