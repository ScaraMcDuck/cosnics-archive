...
abstract class RestExternalExporter extends BaseExternalExporter 
{
	...
	protected function get_rest_client()
	{
	    ...
	    else
	    {
	        ...
	        {
	            $client_certificate_file = Path :: get_repository_path() . 'lib/export/external_export/ssl' . StringTool :: ensure_start_with($client_certificate_file, '/');
	        ...
	        {
	            $client_certificate_key_file = Path :: get_repository_path() . 'lib/export/external_export/ssl' . StringTool :: ensure_start_with($client_certificate_key_file, '/');
	        ...
	        {
	            $target_ca_file = Path :: get_repository_path() . 'lib/export/external_export/ssl' . StringTool :: ensure_start_with($target_ca_file, '/');
