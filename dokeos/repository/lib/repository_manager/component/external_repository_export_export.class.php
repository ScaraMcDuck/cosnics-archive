	    ...
	    if($this->check_content_object_from_params())
		{
		    ...
		    {    
		        try
        	    {
            	    ...
            	    $form = ExternalExportExportForm :: get_instance($content_object, $export, $this->get_url(array(parent :: PARAM_EXPORT_ID => $export->get_id(), RepositoryManager :: PARAM_LEARNING_OBJECT_ID => $content_object->get_id())), null);
