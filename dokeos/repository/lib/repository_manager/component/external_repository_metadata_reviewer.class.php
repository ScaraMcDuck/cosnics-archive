	    ...
	    if($this->check_learning_object_from_params())
		{
            ...
            switch ($metadata_type) 
            {
                case self :: METADATA_FORMAT_LOM:
                    ...
                    $form = new MetadataLOMEditForm($learning_object->get_id(), $mapper, $this->get_url(array(RepositoryManager :: PARAM_LEARNING_OBJECT_ID => $learning_object->get_id(), RepositoryManagerExternalRepositoryExportComponent :: PARAM_EXPORT_ID => Request :: get(RepositoryManagerExternalRepositoryExportComponent :: PARAM_EXPORT_ID))), $this->get_catalogs());
                    break;
                    ...
                    if(isset($mapper))
                    {
                        ...
                        else
                        {
                            ...
                            Redirect :: url(array(Application :: PARAM_APPLICATION => RepositoryManager :: APPLICATION_NAME, 
                                                    ...
                                                    RepositoryManager :: PARAM_LEARNING_OBJECT_ID => $learning_object->get_id(), 
