 ...
 */
require_once dirname(__FILE__).'/databasemdb2/databasemdb2learningobjectresultset.class.php';
...
class Databasemdb2RepositoryDataManager extends RepositoryDataManager
{
	...
	function retrieve_learning_objects($type = null, $condition = null, $orderBy = array (), $orderDir = array (), $offset = 0, $maxObjects = -1, $state = LearningObject :: STATE_NORMAL, $different_parent_state = false)
	{
		...
		return new Databasemdb2LearningObjectResultSet($this, $res, isset($type));
	}
