...
class PortfolioBuilderItemCreatorComponent extends PortfolioBuilderComponent
{
	...
	function run()
	{
		...
		else
		{
			...
			{
				$learning_object = new PortfolioItem();
				$learning_object->set_title('portfolio_item');
				$learning_object->set_description('portfolio_item');
				...
				$cloi = ComplexLearningObjectItem :: factory('portfolio_item');
