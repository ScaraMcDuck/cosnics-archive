 ...
 */
class ComplexLearningObjectRepoViewerBrowserComponent extends RepoViewerBrowserComponent
{
	function ComplexLearningObjectRepoViewerBrowserComponent($parent)
	{
