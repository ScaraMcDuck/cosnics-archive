...
$l_returnindex        = "$l_toreturn ao índice do fórum";
...
$l_banned         = "Foi banido deste fórum. Contacte o administrador se tiver quaisquer dúvidas.";
$l_enterpassword = "Tem de introduzir a sua senha.";

$l_nopost        = "Não tem acesso para colocar mensagens neste fórum.";
$l_noread        = "Não tem acesso para ler este fórum.";
...
$l_private         = "$l_privateforum<br>Nota: Precisa de ter cookies activos para usar os fóruns privados.";
$l_noprivatepost = "$l_privateforum Não tem acesso para colocar mensagens nesse fórum.";
...
-$users_online- ". ($users_online==1?"utilizador está":"utilizadores estão") ." <a href=\"$online_url\">actualmente a navegar</a> pelos fóruns.<br>";';
...
$l_welcomesubj        = "Bem vindo aos Fóruns $sitename";
$l_welcomemail        =
"
$l_welcomesubj,
...
$l_nousers        = "Nenhum utilizador está actualmente a navegar nos fóruns";
...
colocou nos Fóruns $sitename recebeu uma resposta, e
...
Ou ver o Índice do Fórum $sitename em
...
$lang_edit_post="Editar mensagem";
$lang_new_topic="Novo tópico";
$lang_post_new_topic_in="Publicar novo tópico em";
?>