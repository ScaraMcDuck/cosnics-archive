...
$l_alwaysdisable = "Sempre desabilitado";
$l_boardlang     = "Idioma da Tela";
...
$l_editdelete = "Editar/Apagar esta Postagem";
$l_replyquote = "Responder com quota";
$l_viewip = "Ver IP dos Postadores (Moderadores/Administradores Apenas)";
$l_locktopic = "Bloquear este Tópico";
$l_unlocktopic = "Desbloquear este Tópico";
$l_movetopic = "Mover este Tópico";
$l_deletetopic = "Apagar este Tópico";
...
$l_editprefs = "Edite Suas Preferências";
$l_search = "Procurar";
$l_memberslist = "Lista de Membros";
$l_faq = "FAQ";
$l_privmsgs = "Menssagens privadas";
...
$l_alwayssmile = "Sempre desabilitado Smilies";
$l_alwayshtml = "Sempre desabilitado HTML";
$l_alwaysbbcode = "Sempre desabilitado BBcode";
$l_boardtheme = "Tema da Tela";
$l_nothemes = "Não há temas no banco de dados";
$l_saveprefs = "Salvar Preferências";
...
$l_permdeny = "Você não forneceu a Senha correta ou não possui permissões para editar esta postagem. Por favor volte e tente novamente.";
$l_editedby = "Esta Menssagem foi editada por:";
...
$l_cansend = "pode enviar Menssagens privadas";
...
$l_smilepict = "Figura";
$l_wrongactiv = "A chave de ativação fornecida não está correta. Por favor verifique o e-mail Mensagem que você recebeu e tenha certeza de que você copiou a chave de ativação corretamente.";
...
$langHelp = "Ajuda";
$langLastMsgs = "Última mensagem";
$l_quotemsg = "Mensagem";
$lang_mail_notification_title = "reposta ao tópico:";
$lang_mail_notification_captatio = "Senhor (a)";
$lang_mail_notification_hasreplied = "respondeu a uma mensagem do fórum";
$lang_mail_notification_ofcourse = "do curso";
$lang_mail_notification_informed = "Você selecionou a opção para ficar informado sobre respostas a esta mensagem do fórum.";
$lang_mail_notification_yesiwant = "Sim, Eu quero ser informado por e-mail (".$_user['mail'].") sempre que este tópico receber novas participações.";
$lang_reply_this_message = "Responder esta mensagem";
$lang_author = "Autor";
$lang_threaded_view = "Visualizar Árvore";
$lang_flat_view = "Visualizar Flat";
$lang_lock = "Bloquear";
$lang_unlock = "Desbloquear";
$lang_locked = "Bloqueado";
$lang_edit_post = "Editar postagem";
$lang_new_topic = "Novo Tópico";
$lang_post_new_topic_in = "Novo tópico em";
$langLock = "Travar";
$langPostNewTopic = "Postar um novo tópico";
?>