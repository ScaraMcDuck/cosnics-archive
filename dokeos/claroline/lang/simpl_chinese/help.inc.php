...
$langHFor = "论坛帮助";
$langClose = "关闭窗口";
$langForContent = "论坛,是异步讨论工具.电子邮件使用一对一的对话方式,论坛则使得公共对话或者半公共的对话成为可能.</p><p>从技术上讲,使用claroline论坛只需要使用浏览器就可以.</P><p>组织论坛,请点击\'管理\'.论坛按照类和子类组织起来,如下:</p><p><b>分类 > 论坛 > 论题 > 回复 </b></p>为使学生的讨论有一个清晰的结构,预先组织分类和论坛是必要的.让学生来发表话题和回复.默认设置,claroline论坛只包含\'Public\'分类 -- 示例性的论坛和话题.</p><p>所以首先要做的事,删除话题示例,更新第一个论坛的名称.接下来,可以在\'public\'分类中按照小组或主题创建新的论坛来满足课程学习环境的需要.</p><p>不要混淆分类和论坛, 也不要忘记空的类别(不含有论坛)对学生是不可见的.</p><p>论坛的简介可以是它的用户列表,目标,任务,主题等等";
$langHHome = "网站帮助";
...
<h4>为文件(或者目录)更名</h4>
<ul>
  <li>点击<img src=../img/renommer.gif width=20 height=20 align=baseline> 按钮(位于\'更名\'栏)</li>
  <li>在左上角区域填写新的文件名</li>
  ...
  <li>点击 <img src=../img/delete.gif width=20 height=20> 
	(位于 \'删除\'栏).</li>
	</ul>
	<h4>显示/隐藏文件(或目录)</h4>
	<ul>
	  
  <li>点击 <img src=../img/visible.gif width=20 height=20>位于\'显示/隐藏\'栏.</li>
	  <li>隐藏文件(或目录)后,它还是存在的,只是对学生已经不可见.</li>	  
  <li>要使得其对学生可见, 点击 <img src=../document/../img/invisible.gif width=24 height=20> 
	(位于\'显示/隐藏\'栏)</li>
	</ul>
	<h4>为文件(或目录)添加或更新摘要</h4>
	<ul>	  
  <li>点击 <img src=../document/../img/comment.gif width=20 height=20> 
	(位于\'摘要\'栏)</li>
	  <li>在右上角相应区域填写新的摘要.</li>
	  <li>确认,点击<input type=submit value=OK name=submit2>
		.</li>
	</ul> 
	<p>删除摘要,点击 <img src=../document/../img/comment.gif width=20 height=20>, 
	...
	<h4><b>创建一个目录</b></h4>
	<ul>
	  <li>点击 <img src=../document/../img/dossier.gif width=20 height=20> \'创建目录\'(左上角)</li>
	  <li>在相应区域键入新目录的名称(左上角)</li>
	  <li>确认,点击 <input type=submit value=OK name=submit23>.</li>
	</ul>
	<h4>移动文件(或目录)</h4>
	<ul>
	  <li>点击 <img src=../document/../img/deplacer.gif width=34 height=16> 
		位于\'移动\'栏</li>
