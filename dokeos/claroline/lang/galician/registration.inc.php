...
$langEnter2passToChange = "Introudce o teu contrasinal dúas veces para cambialo.  Se non queres cambialo, deixa o espacio en branco.";
$langAuthInfo = "Autentificación";
$langOfficialCode = "Código oficial(ID)";
$langDelImage = "Borrar imaxe";
$langUpdateImage = "Cambiar imaxe";
$langImageWrong = "O arquivo da imaxe debe ser menor de";
...
$lang_enter_email_and_well_send_you_password = "Introduci-lo enderezo de correo electr&oacute,nico que utilizaches para rexistrarte e remitirémosche o contrasinal.";
$langLogin = "Entrar";
$langAction = "Acción";
...
$langCourses = "cursos.";
$langIfYouWantToAddManyUsers = "Se queres engadir unha lista de usuarios ó teu curso, contacte co administrador.";
...
$langSend = "Enviar";
$langUserAddExplanation = "Cada liña do arquivo que envíe necesariamente ten que incluir
...
$langDear = "Estimado(a)";
$langYourReg = "A súa inscripción en";
...
$langUserProfileReg = "Rexistrouse o e-portafolio do usuario";
