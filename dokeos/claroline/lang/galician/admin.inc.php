...
$langProtectedDocument = "poñer un arquivo .htaccess no directorio /document/ para evitar accesos non autorizados";
...
$langPleaseEnterValidEmail = "Por favor, introduce unha dirección de correo electrónico válida";
...
$langImportUserListXMLCSV = "Importar unha lista de usuarios dun arquivo XML/CSV";
$langExportUserListXMLCSV = "Exportar a lista de usuario de un arquivo XML/CSV";
...
$langImportFileLocation = "Localización do arquivo CSV/XML";
$langFileType = "Tipo de arquivo";
$langOutputFileType = "Tipo de arquivo de saída";
$langMustUseSeparator = "debe usar o caracter \';\' como separador";
$langCSVMustLookLike = "O arquivo CSV debe ter este aspecto";
$langXMLMustLookLike = "O arquivo XML debe ter este aspecto";
$langMandatoryFields = "Os campos en <strong>negriña</strong> son obligatorios.";
$langNotXML = "O arquivo especificado non ten formato XML";
$langNotCSV = "O arquivo especificado non ten formato CSV";
$langNoNeededData = "O arquivo especificado non contén todos os datos necesarios";
...
$SettingsStored = "As opcións foron gardadas";
...
$emailAdministratorComment = "O email do administrador da plataforma (aparece no pé a esquerda)";
$administratorSurnameTitle = "Administrador de Plataforma: Apelidos";
$administratorSurnameComment = "Apelidos do administrador da plataforma (aparecen no pé de páxina, a esquerda)";
...
$HomepageViewDefault = "Estructura en duas columnas. As ferramentas inactivas ocultas.";
...
$AllowUserHeadingsComment = "Un administrador do curso ¿pode definir cabeceiras de usuario para recoller máis información dos usuarios?";
$Platform = "Plataforma";
$Course = "Curso";
$Languages = "Linguas";
$Tools = "Ferramentas";
...
$PermanentlyRemoveFilesTitle = "Arquivos eliminados non poden ser recuperados";
$PermanentlyRemoveFilesComment = "Borrar un arquivo na ferramenta documentos o elimina de forma definitiva. O arquivo non pode recuperarse.";
$ClassName = "Nome da clase";
$DropboxMaxFilesizeTitle = "Baúl de tarefas: Tamaño máximo por arquivo";
$DropboxMaxFilesizeComment = "¿cal e o tamaño máximo de un documento no baúl?";
$DropboxAllowOverwriteTitle = "Baúl de tarfas: Poden sobreescribirse os documentos";
...
$ClickHereToDownloadTheFile = "Pulsa aquí para descargar o arquivo.";
