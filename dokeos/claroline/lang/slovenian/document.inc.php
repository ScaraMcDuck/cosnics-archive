...
$langScormcontent = "Tole je Scorm vsebina<br><input type=button name=scormbutton value=\'Zaženi it !\' onclick=\'openscorm()\'>";
$langScormcontentstudent = "Tole je teèaj v Scorm obliki. Zaženi teèaj s pritiskom na : <input type=button name=scormbutton value=\'Zaženi it !\' onclick=\'openscorm()\'>";
$langPublish  = "Objavi";
