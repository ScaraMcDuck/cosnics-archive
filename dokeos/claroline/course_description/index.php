...
$location_id = RolesRights::get_course_tool_location_id($course_id, TOOL_COURSE_DESCRIPTION);
...
if ($is_allowed[EDIT_RIGHT] && !is_null($description_id))
{
...
if ($show_description_list)
{
	...
	if (count($descriptions) > 0)
	{
		foreach ($descriptions as $id => $description)
		{
			...
			echo '</div>';
			echo api_parse_tex($description->content);
		}
	}
	else
	{
