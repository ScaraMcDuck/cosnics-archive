...
$langClickKw = "Pulse nunha palabra chave da árbore para seleccionar ou deselecciona-la";
...
$langNonCourseKwds = "Palabras chave non ligadas ó curso";
$langKwdsUse = "Palabras chave do curso (negriña = sen usar)";
