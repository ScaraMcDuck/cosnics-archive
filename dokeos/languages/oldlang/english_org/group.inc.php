...
$langNoGroupDeleted="No group has been deleted";
...
$langFillGroups="Fill groups (random)";
$langGroupsProperties="Groups settings";
//no longer in use: $langStudentRegAllowed="Members are allowed to self-register in groups";
$langStudentRegNotAllowed="Users are not allowed to self-register in groups";
...
$langSubscribed ="users registered in this area";
$langAdminsOfThisCours ="leader";

$langGroupMembers="Members";
$langEditGroup="Edit this group";
$langUncompulsory="(optional)";
$langNoGroupStudents="Unassigned users";
$langGroupMembers="Group members";
$langGroupCancel="cancel";
$langGroupSettingsModified="Group settings modified";

$langGroupStudentsInGroup="users registered in groups";
$langGroupStudentsRegistered="usersregistered to this area";
$langGroupNoGroup="unassigned users";
