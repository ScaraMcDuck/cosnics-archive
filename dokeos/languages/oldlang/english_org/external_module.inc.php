<?php // $Id: external_module.inc.php 1997 2004-07-07 14:55:42Z olivierb78 $
/*
      +----------------------------------------------------------------------+
      | DOKEOS 1.5 $Revision: 1997 $                                          |
      +----------------------------------------------------------------------+
...
$langSubTitle          = "Adds a link to a page on the homepage of your area. To do this, go to that page, copy its URL in the address bar on the top of your browser, and paste it into the \"Link\" field below.";
...
$langOkSentLink        = "Your link has been added.<p>It is now accessible from the <a href=\"../../".$_course['path']."/index.php\">Homepage</a>";
