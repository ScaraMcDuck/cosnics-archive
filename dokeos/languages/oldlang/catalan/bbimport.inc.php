...
$langImportExternalLinks  = "Importar links (Blackboard mòdul \"Enllaços externs)";
$langImportForum  = "Importar fòrums (Blackboard mòdul \"Foro de discussió\")";
...
$langPackageAlreadySelected = "Ja ha seleccionat el curs en un paquet";
$langFirstSelectPackage = "Has de seleccionar un paquet i obrir-lo abans de continuar amb la importació";
...
$langChooseImportOptions = "Escolleix les teves opcions d\'importació";
$langCheckWhatIsImported = "Pots verificar per a veure que serà importat abans de començar el procès d\'importació";
