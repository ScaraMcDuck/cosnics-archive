...
$langNoManifest = "(无manifest 文件...)";
$langNotFolder = "不可能, 它不是一个文件夹...";
$langUploadHtt = "上传HTT 文件";
$langHttFileNotFound = "新的 HTT 文件无法打开 (因为空或太大)";
$langHttOk = "新HTT文件已经上传";
$langHttNotOk = "上传HTT 文件失败";
$langRemoveHtt = "删除 HTT 文件";
$langHttRmvOk = "HTT 文件已被删除";
$langHttRmvNotOk = "删除HTT 文件失败";
$langImport = "从manifest 创建 MDE";
$langRemove = "删除 MDE";
