...
DROP TABLE IF EXISTS `main_basic_right`;
CREATE TABLE `main_basic_right` (
...
--
-- Dumping data for table `main_basic_right`
--


/*!40000 ALTER TABLE `main_basic_right` DISABLE KEYS */;
LOCK TABLES `main_basic_right` WRITE;
INSERT INTO `main_basic_right` VALUES (1,'ViewRight','ViewRightDescription'),(2,'EditRight','EditRightDescription'),(3,'AddRight','AddRightDescription'),(4,'DeleteRight','DeleteRightDescription');
UNLOCK TABLES;
/*!40000 ALTER TABLE `main_basic_right` ENABLE KEYS */;
...
DROP TABLE IF EXISTS `main_class_user`;
CREATE TABLE `main_class_user` (
...
--
-- Dumping data for table `main_class_user`
--


/*!40000 ALTER TABLE `main_class_user` DISABLE KEYS */;
LOCK TABLES `main_class_user` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `main_class_user` ENABLE KEYS */;
...
DROP TABLE IF EXISTS `main_location`;
...
--
-- Dumping data for table `main_location`
--
...
/*!40000 ALTER TABLE `main_location` DISABLE KEYS */;
LOCK TABLES `main_location` WRITE;
...
UNLOCK TABLES;
/*!40000 ALTER TABLE `main_location` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `main_role` DISABLE KEYS */;
LOCK TABLES `main_role` WRITE;
INSERT INTO `main_role` VALUES
...
UNLOCK TABLES;
/*!40000 ALTER TABLE `main_role` ENABLE KEYS */;

--
-- Table structure for table `role_right_location`
--

DROP TABLE IF EXISTS `main_role_right_location`;
CREATE TABLE `main_role_right_location` (
...
--
-- Dumping data for table `main_role_right_location`
--


/*!40000 ALTER TABLE `main_role_right_location` DISABLE KEYS */;
LOCK TABLES `main_role_right_location` WRITE;
INSERT INTO `main_role_right_location` VALUES
(6, 1, 1, '1'),
(6, 1, 7, '1'),
(6, 1, 11, '1'),
(6, 1, 12, '1'),
...
(9, 4, 25, '1');
UNLOCK TABLES;
/*!40000 ALTER TABLE `main_role_right_location` ENABLE KEYS */;
...
DROP TABLE IF EXISTS `main_settings_current`;
CREATE TABLE `main_settings_current` (
...
--
-- Dumping data for table `main_sys_announcement`
--


/*!40000 ALTER TABLE `main_sys_announcement` DISABLE KEYS */;
LOCK TABLES `main_sys_announcement` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `main_sys_announcement` ENABLE KEYS */;
...
--
-- Dumping data for table `main_user_role`
--


/*!40000 ALTER TABLE `main_user_role` DISABLE KEYS */;
LOCK TABLES `main_user_role` WRITE;
UNLOCK TABLES;
/*!40000 ALTER TABLE `main_user_role` ENABLE KEYS */;
