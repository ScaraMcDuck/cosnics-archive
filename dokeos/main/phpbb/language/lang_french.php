...
$l_aboutpost	= "Concernant l'ajout de message";
...
$l_emailpass	= "Recevoir mon mot de passe par e-mail";
...
$lang_mail_notification_title="réponse sur topic : "; 
$lang_mail_notification_captatio="Cher "; 
$lang_mail_notification_hasreplied=" a répondu sur un message ";
$lang_mail_notification_ofcourse=" du cours ";
$lang_mail_notification_informed="Vous aviez indiqué que vous voulliez être tenu au courant des réponses sur ce message."; 
$lang_mail_notification_yesiwant="Oui, je veux être tenu au courant par e-mail ( ".$_user ['mail']." ) des réponses sur ce message";

// ADDED BY UGENT, Patrick Cool, march 2004, flat/thread view
$lang_reply_this_message="Répondez sur ce message"; 
$lang_author="Auteur";
$lang_threaded_view="Vue en arborescence";
$lang_flat_view="Vue à plat";
$lang_lock="Verrouiller";
$lang_unlock="Déverrouiller";
$lang_locked="verrouillé";
$lang_edit_post="Editer un message";
$lang_new_topic="Nouveau sujet";
$lang_post_new_topic_in="Poster un nouveau sujet dans";
?>
