...
{
	if(!strstr($_SERVER['PHP_SELF'], "topicadmin"))
	{
		$config_file_name = "../config.$phpEx";
	}
}
...
//previous version : $last_visit = $_SESSION['user_last_login_datetime'];

// The code above was customized by Dokeos team.
// Previously, PhpBB works with a cookie concerning the las forum visit.
// In Dokeos, we use instead a variable stored in session
