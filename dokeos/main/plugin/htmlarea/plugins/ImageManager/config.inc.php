...
$includePath=str_replace('\\','/',realpath(dirname(__FILE__).'/../../../../inc'));

include_once($includePath.'/claro_init_global.inc.php');

$documentPath=api_get_path(SYS_COURSE_PATH).$_course['path'].'/document/';

if(!is_dir($documentPath.'images'))
{
	if(is_file($documentPath.'images'))
	{
		@unlink($documentPath.'images');
	}

	@mkdir($documentPath.'images',0777);
	@chmod($documentPath.'images',0777);
}
...
*/
$IMConfig['base_dir'] = $documentPath.'images/';
...
*/
$IMConfig['base_url'] = api_get_path(WEB_COURSE_PATH).$_course['path'].'/document/images/';
...
*/
define('IMAGE_TRANSFORM_LIB_PATH', '/usr/');
