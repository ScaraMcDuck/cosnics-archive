...
$location_id = RolesRights::get_course_tool_location_id($course_id, TOOL_LINK);
...
-----------------------------------------------------------
*/
Display::display_introduction_section(TOOL_LINK, $is_allowed);
...
while ($myrow=@mysql_fetch_array($resultcategories))
	...
	$myrow["description"]=api_parse_tex($myrow["description"]);
	if ($urlview[$i]=="1")
		{
		$newurlview=$urlview;
		$newurlview[$i]="0";
