...
$DirectoryAndFilePermissionsInfo = "Sommige mappen en de bestanden erin moeten overschrijfbaar zijn door de web server opdat Dokeos zou kunnen werken (door studenten ge�ploade bestanden, HTML-bestanden voor de startpagina,...). Dit vraagt mogelijk een manuele wijziging op uw server (buiten deze interface).";
...
$GoToYourNewlyCreatedPortal = "Ga naar uw ge�nstalleerde portaal.";
...
$NewInstall = "Nieuwe installatie";
$RepositoryDatabase = "Repository databank";
$WeblcmsDatabase = "WebLCMS databank";
?>