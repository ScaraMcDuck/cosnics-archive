 ...
 * 		care of the translations) this file must be placed in the .../main/lang/English/
 * 		directory and the copy of this file that contains the translations must be placed in 
 * 		the .../main/lang/YourLang/ directory. Be sure to give the translated version the same 
 * 		name as this one.
 * 		- if you're sure you will only need the dropbox module in 1 language, you can just leave this
 * 		file in the current directory (.../main/plugin/dropbox/) and translate each variable into
