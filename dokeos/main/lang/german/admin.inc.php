...
$langDevAdmin  = "Entwicklung Administration";
$langLinksToClaroProjectSite  = "Link zur Projekt Webseite";
$langStatistiques  = "Statistik";
$langNbProf  = "Anzahl Lehrer/innen";
$langNbStudents  = "Anzahl Teilnehmer/innen";
$langNbLogin  = "Anzahl Logins";
$langToday    = "heute";
$langLast7Days  = "letzte 7 Tage";
$langLast30Days  = "letzte 30 Tage";
$langNbAnnoucement  = "Anzahl Anmeldungen";
$langCheckDatabase  = "Hauptdatenbank prüfen";
$langPleaseCheckConfigForMainDataBaseName  = "Bitte diese Werte überprüfen <br>Hauptdatenbank in <br>";
...
$langAtLeastOneUser = "Es muss mindestens <i>ein</i> Nutzer selektiert werden!";
