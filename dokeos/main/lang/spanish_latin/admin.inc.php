...
$langToday    = "Hoy";
$langLast7Days  = "Ultimos 7 días";
$langLast30Days  = "Ultimos 30 días";
$langNbAnnoucement  = "Cantidad de Anuncios";
$langCheckDatabase  = "Verificar la base de datos principal";
...
$langStatus = "Tipo de usuario";
$langEmail = "Email";
$langActions = "Acciones";
$langAddToCourse = "Agregar a un curso";
$langDeleteFromPlatform = "Eliminar de la Plataforma";
$langDeleteCourse = "Borrar el(los) curso(s) ";
$langDeleteFromCourse = "Eliminar de este curso";
...
$PlatformLanguageComment = "Usted puede determinar el idioma de la plataforma en una parte diferente del administrador de la plataforma, llamado <a href=\\\"languages.php\\\">Idioma de la plataforma Dokeos</a>";
$PlatformLanguageTitle = "Idioma de la plataforma";
