...
";
$langMffNotOk = "El reemplazo del fichero manifest no ha sido posible";
...
$langMfMissing = "El fichero manifest no ha sido encontrado";
$langMfFile = "Archivo manifest";
$langMfSyntaxError = "Errores sintácticos en el fichero manifest";
