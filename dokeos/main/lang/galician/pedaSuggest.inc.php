...
*/
$GeneralDescription = "Descripción xeral";
...
$GeneralDescriptionInformation = "Descripción do curso (número de horas, código, lugar onde se desenvolve...). Profesor (nome, apelidos, despacho, teléfono, e-mail...).";
...
$Topics = "Contidos";
$TopicsInformation = "Lista de contidos do curso. Importancia de cada contido. Nivel de dificultade. Estructura e interdependencia entre os seus apartados.";
$TopicsQuestions = "¿Cal será o desenvolvemento do curso? ¿Onde deben prestar especial atención os estudiantes? ¿Hai problemas identificados na comprensión dalgúns capítulos? ¿Cánto debe adicarse a cada parte do curso ?";
...
$HumanAndTechnicalResourcesInformation = "Descripción breve das persoas de contacto e dos recursos técnicos dispoñibles.";
$Assessment  = "Avaliación";
$AssessmentQuestions = "¿Cómo se van avaliar os estudiantes? ¿Cales son as estratexias para que dominen a materia?";
