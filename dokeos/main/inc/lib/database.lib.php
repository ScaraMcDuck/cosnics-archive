...
define("MAIN_SYSTEM_ANNOUNCEMENTS_TABLE", "main_sys_announcement");
define("MAIN_LANGUAGE_TABLE", "main_language");
define("MAIN_SETTINGS_OPTIONS_TABLE", "main_settings_options");
define("MAIN_SETTINGS_CURRENT_TABLE", "main_settings_current");
