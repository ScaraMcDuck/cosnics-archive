 ...
 *
 * @return
 * @authot Christophe Gesch�gesch�ipm.ucl.ac.be
...
function echoSessionValue()
{
	...
	$infoResult .= "
			...
			<strong>date de derni�e modification de la page</strong> : ".date("j-m-Y", getlastmod());
	/*
	...
	set_magic_quotes_runtime --  Active/d�active l'option magic_quotes_runtime.
	set_time_limit -- Fixe le temps maximum d'ex�ution d'un script.
	*/
	$infoResult .= "
			<strong>Type d'interface utilis�entre le serveur web et PHP</strong> : ".php_sapi_name()."
			<strong>informations OS</strong> : ".php_uname()."
			<strong>Version courante du moteur Zend</strong> : ".zend_version()."
			<strong>GID du propri�aire du script</strong> : ".getmygid()."
			<strong>inode du script</strong> : ".getmyinode()."
			<strong>num�o de processus courant</strong> : ".getmypid()."
			<strong>UID du propri�aire du script actuel</strong> : ".getmyuid()."
 ...
 * @desc io file
 * @return
 * @author Christophe Gesch�gesch�ipm.ucl.ac.be
 * @deprecated Function not in use
 */
