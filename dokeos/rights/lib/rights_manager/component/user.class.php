 ...
 * Admin component
 */
class RightsManagerUserComponent extends RightsManagerComponent
{
    ...
    function run()
    {
		...
		$trail->add(new Breadcrumb($this->get_url(array(Application :: PARAM_ACTION => RightsManager :: ACTION_MANAGE_USER_RIGHTS)), Translation :: get('ManageUserRights')));
...
//        }
        ...
        $package_manager = new UserRightManager($this->get_parent());
        $package_manager->run();
    }
}
?>