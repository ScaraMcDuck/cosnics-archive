...
require_once dirname(__FILE__).'/wizard/databaseinstallwizardpage.class.php';
require_once dirname(__FILE__).'/wizard/applicationinstallwizardpage.class.php';
require_once dirname(__FILE__).'/wizard/settingsinstallwizardpage.class.php';
