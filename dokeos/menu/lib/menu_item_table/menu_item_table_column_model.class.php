 ...
 */
class MenuItemTableColumnModel
{
	/**
	...
	/**
	 * Constructor. Creates a new menu object table model.
	 * @param array $columns The columns to use in the table. An array of
	 *                       ObjectTableColumn instances.
	 ...
	 *                                        or SORT_DESC.
	 */
	function MenuItemTableColumnModel($columns, $default_order_column = 0, $default_order_direction = SORT_ASC)
	{
	 ...
	 * @return MenuManagerTableColumn The column.
	 */
	 ...
	 * @param MenuManagerTableColumn The column.
	 */
	...
	/**
	 * Gets the index of the column to order menu objects by by default.
	...
	/**
	 * Sets the index of the column to order menu objects by by default.
