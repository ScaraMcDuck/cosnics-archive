 ...
 */
class DatabaseUserResultSet extends ResultSet {
	/**
	 ...
	 */
    function DatabaseUserResultSet($data_manager, $handle, $single_type)
    {
    ...
    function next_result()
    {
		...
		{
			return $this->data_manager->record_to_user($record);
		}
    	return null;
    }
	/*
