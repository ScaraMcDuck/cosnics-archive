...
class UserSearchForm extends FormValidator
{
	...
	private function get_search_conditions()
	{
		...
		{
			$conditions = array ();
			$conditions[] = new EqualityCondition(User :: PROPERTY_USERNAME, $values[self :: PARAM_SIMPLE_SEARCH_QUERY]);
			$conditions[] = new EqualityCondition(User :: PROPERTY_LASTNAME, $values[self :: PARAM_SIMPLE_SEARCH_QUERY]);
