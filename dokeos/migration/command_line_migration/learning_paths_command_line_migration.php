...
<?php
	...
	require_once(dirname(__FILE__) . '/../lib/migration_manager/component/inc/wizard/course/learning_paths_migration_wizard_page.class.php');
	...
	$wizardpage = new LearningPathsMigrationWizardPage(null, null, true);
