...
<?php
	...
	require_once(dirname(__FILE__) . '/../lib/migration_manager/component/inc/wizard/course/surveys_migration_wizard_page.class.php');
	...
	$wizardpage = new SurveysMigrationWizardPage(null, null, true);
