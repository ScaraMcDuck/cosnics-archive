...
<?php
	...
	require_once(dirname(__FILE__) . '/../lib/migration_manager/component/inc/wizard/course/quiz_migration_wizard_page.class.php');
	...
	$wizardpage = new QuizMigrationWizardPage(null, null, true);
