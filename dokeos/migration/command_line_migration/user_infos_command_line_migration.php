...
<?php
	...
	require_once(dirname(__FILE__) . '/../lib/migration_manager/component/inc/wizard/course/user_infos_migration_wizard_page.class.php');
	...
	$wizardpage = new UserinfosMigrationWizardPage(null, null, true);
