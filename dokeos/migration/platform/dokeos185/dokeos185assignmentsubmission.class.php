...
class Dokeos185AssignmentSubmission extends ImportAssignmentSubmission
{
	...
	function is_valid($array)
	{
		...
		if(!$this->get_assignment_id() || !$this->get_submitted_doc_path()|| !file_exists(self :: $mgdm->append_full_path(false,$old_rel_path . $filename)) )
		{		 
			self :: $mgdm->add_failed_element($this->get_id(),
				$course->get_db_name() . '.assignment_submission');
			return false;
		}
		return true;
	}
