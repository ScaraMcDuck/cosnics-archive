...
class Dokeos185ItemProperty extends Import
{
	...
	{
		return array (self :: PROPERTY_TOOL, self :: PROPERTY_INSERT_USER_ID, 
					  self :: PROPERTY_INSERT_DATE, self :: PROPERTY_LASTEDIT_DATE,
					  self :: PROPERTY_REF, self :: PROPERTY_LASTEDIT_TYPE, 
					  self :: PROPERTY_LASTEDIT_USER_ID, self :: PROPERTY_TO_GROUP_ID,
					  self :: PROPERTY_TO_USER_ID, self :: PROPERTY_VISIBILITY,
					  self :: PROPERTY_START_VISIBLE, self :: PROPERTY_END_VISIBLE);
	}
	...
	/**
	 * Sets the tool of this item property.
	 * @param int $tool The tool.
	 */
	...
	/**
	 * Sets the insert_user_id of this item property.
	 * @param string $insert_user_id The insert_user_id
	 */
	function set_insert_user_id($insert_user_id)
	{
		$this->set_default_property(self :: PROPERTY_INSERT_USER_ID, $insert_user_id);
	}
	
	/**
	 * Sets the insert_date of this item property.
	 * @param string $insert_date The insert_date
	 */
	function set_insert_date($insert_date)
	{
		$this->set_default_property(self :: PROPERTY_INSERT_DATE, $insert_date);
	}
	
	/**
	 * Sets the lastedit_date of this item property.
	 * @param string $lastedit_date The lastedit_date
	 */
	function set_lastedit_date($lastedit_date)
	{
		$this->set_default_property(self :: PROPERTY_LASTEDIT_DATE, $lastedit_date);
	}
	
	/**
	 * Sets the ref of this item property.
	...
	/**
	 * Sets the lastedit_type of this item property.
	 * @param string $lastedit_type The lastedit_type
	 */
	function set_lastedit_type($lastedit_type)
	{
		$this->set_default_property(self :: PROPERTY_LASTEDIT_TYPE, $lastedit_type);
	}
	
	/**
	 * Sets the lastedit_user_id of this item property.
	 * @param int $lastedit_user_id The lastedit_user_id.
	 */
	function set_lastedit_user_id($lastedit_user_id)
	{
		$this->set_default_property(self :: PROPERTY_LASTEDIT_USER_ID, $lastedit_user_id);
	}
	
	/**
	 * Sets the to_group_id of this item property.
	 * @param string $to_group_id The to_group_id
	 */
	function set_to_group_id($to_group_id)
	{
		$this->set_default_property(self :: PROPERTY_TO_GROUP_ID, $to_group_id);
	}
	
	/**
	 * Sets the to_user_id of this item property.
	 * @param string $to_user_id The to_user_id
	 */
	...
	/**
	 * Sets the visibility of this item property.
	...
	/**
	 * Sets the start_visible of this item property.
	 * @param string $start_visible The start_visible
	 */
	function set_start_visible($start_visible)
	{
		$this->set_default_property(self :: PROPERTY_START_VISIBLE, $start_visible);
	}
	
	/**
	 * Sets the end_visible of this item property.
	 * @param string $end_visible The end_visible
	 */
	function set_end_visible($end_visible)
	{
		$this->set_default_property(self :: PROPERTY_END_VISIBLE, $end_visible);
	}
}
?>